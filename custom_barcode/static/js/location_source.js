//odoo.define('custom_barcode.LocationView', function (require) {
//"use strict";
//
...
//var _t = core._t;
//
//var LocationView = Widget.extend(BarcodeHandlerMixin, {
//    template: 'location_view',
//
...
//        var self = this;
//        Session.rpc('/custom_barcode/scan_src_location', {
//            barcode: barcode,
...
//});
//
//core.action_registry.add('stock_barcode_main_menu', LocationView);
//
//return {
...
var LocationView = AbstractAction.extend({
    template: 'location_view',
...
core.action_registry.add('scan_stock_src_location_barcode', LocationView);
